...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'mofater@intelyes.onmicrosoft.com',
  ...
  email: 'mailto:https://dailybing.com/',
